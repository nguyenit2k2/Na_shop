...
class ProductController extends Controller
{
    ...
    public function delete_product($product_id){
        ...
        Session::put('message','Xóa trò chơi thành công');
        return Redirect::to('all-product');
    }
    //End Admin Page
    public function details_product($product_slug , Request $request){
        ...
        $comment = DB::table('tbl_comment')->where('product_id',$product_id)->orderby('time','desc')->get();
        ...
        return view('pages.sanpham.show_details')->with('comment',$comment)->with('category',$cate_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider);
