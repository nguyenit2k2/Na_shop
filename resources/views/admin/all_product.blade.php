      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            ...
            <th style="width:160px;">Tên trò chơi</th>
            <th>Số lượng</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <?php if( $pro->product_type==0){ ?>
            <td>Game Hot</td>
            <?php }else{ ?>
              <td>Game Thịnh Hành</td>
              <?php
            } ?>
            ...
            <td>
            <a href="{{URL::to('/view-comment/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
