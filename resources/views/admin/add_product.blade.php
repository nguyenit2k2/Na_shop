                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="length" data-validation-length="min4" data-validation-error-msg="Làm ơn điền ít nhất 10 ký tự" name="product_name" class="form-control " id="slug" placeholder="Tên danh mục" onkeyup="ChangeToSlug();"> 
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">SL trò chơi</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_slug" class="form-control " id="convert_slug" placeholder="Tên danh mục">
                                     ...
                                     <div class="form-group">
                                    <label for="exampleInputEmail1">Giá trò chơi</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Xu Hướng</label>
                                      <select name="product_type" class="form-control input-sm m-bot15">
                                       
                                            <option value="0">Game Hot</option>
                                            <option value="1">Game Thịnh Hành</option>
