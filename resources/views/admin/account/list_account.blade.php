          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
              <?php
               if($account->status==1){
                ?>
                <a href="{{URL::to('/unactive-account/'.$account->acc_id)}}"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                <?php
                 }else{
                ?>  
                 <a href="{{URL::to('/active-account/'.$account->acc_id)}}"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                <?php
               }
              ?>
            </span></td>
