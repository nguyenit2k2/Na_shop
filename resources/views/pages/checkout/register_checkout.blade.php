...
<body>
        ...
        <div class="content-wrapper">
           ...
           <div class="icon-game">
                            ...
                            <h1 class="title">NA SHOP</h1>
                            <div class="slogan">GAME BẢN QUYỀN</div>
                        </div>
                    ...
                    <div class="signup-form ">
                        <div class="wrapper-2">
                            <div class="form-title"><b>Đăng Kí</b></div>
                        ...
                        ?>
                            <div class="form">
                                <form action="{{URL::to('/add-customer')}}" method="POST">
                                    ...
                                    <p class="content-item">
                                        <b><label>Email</b>
                                            <input type="text" name="customer_email" placeholder="Example@gmail.com"  required>
                                        </label>
                                    </p>
                                    <p class="content-item">
                                        <b> <label>Số điện thoại</b>
                                    ...
                                    <a href="{{URL::to('/dang-nhap')}}" class="signup">Đăng Nhập</a>
                                </form>
                            </div>
                        </div>
...
.signup-wrapper .company-details {
    background: url(https://gamek.mediacdn.vn/133514250583805952/2020/1/16/1-15791579653801179133828.png);
