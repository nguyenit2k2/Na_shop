        ...
        <div class="content-wrapper">
           ...
           <div class="icon-game">
                    ...
                    <div class="signup-form ">
                        <div class="wrapper-2">
                            <div class="form-title"><h2>Đăng Nhập</h2></div>
                            <br>
                            <?php
                            ...
                            <div class="form">
                                <form action="{{URL::to('/login-customer')}}" method="POST">
                                    ...
                                    <p class="content-item">
                                        <b><label>Email</b>
                                            <input type="text" name="email_account" placeholder="Example@gmail.com"  required>
                                        </label>
                                    </p>
                                    <p class="content-item">
                                    ...
                                    <a href="{{URL::to('/dang-ki')}}" class="signup">Đăng Kí</a>
                                </form>
                            </div>
                        </div>
